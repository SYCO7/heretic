...
def test_trace_records_confirmed_and_dropped():
    ...
    # every executed primitive test is logged (6 BOLA + 5 logic + 3 mechanical probes:
    # mass-assign, price-tamper, workflow — all drop on the mock); chains aren't executed
    assert len(ts.records) == 14
